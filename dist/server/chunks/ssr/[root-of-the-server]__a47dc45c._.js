...
const useTossAuth = ()=>{
    ...
    const tossLogin = async ()=>{
        try {
            ...
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$work$2f$health$2d$hero$2f$node_modules$2f40$apps$2d$in$2d$toss$2f$web$2d$bridge$2f$built$2f$bridge$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["appLogin"])();
    ...
    const login = async ()=>{
        ...
        try {
            ...
            if (userResult.resultType === 'FAIL' || userResult.resultType === 'FAILURE') {
                ...
                throw new Error(`사용자 정보 조회 실패 (${authResult.referrer}): ${__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$work$2f$health$2d$hero$2f$src$2f$utils$2f$errorHandler$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ErrorHandler"].getErrorMessage(tossError)}`);
            }
    ...
    static async createOrUpdateUser(tossData) {
        ...
        try {
            ...
            if (existingProfile) {
                ...
                const { error: signInError } = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$work$2f$health$2d$hero$2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.signInWithPassword({
            ...
            const profileData = {
                ...
                total_score: existingProfile?.total_score || 500,
...
function TossLoginButton() {
    ...
    const [isClient, setIsClient] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$work$2f$health$2d$hero$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$work$2f$health$2d$hero$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            isClient && "undefined" !== 'undefined' && typeof window.appLogin === 'undefined' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$work$2f$health$2d$hero$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
"[project]/Desktop/work/health-hero/src/components/GuestLoginButton.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function GuestLoginButton() {
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$work$2f$health$2d$hero$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$work$2f$health$2d$hero$2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRouter"])();
    const handleGuestLogin = async ()=>{
        try {
            setLoading(true);
            // Supabase 익명 인증
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$work$2f$health$2d$hero$2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.signInAnonymously();
            if (error) throw error;
            console.log("Guest login successful:", data);
            // 게스트 사용자 프로필 생성
            if (data.user) {
                const { error: profileError } = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$work$2f$health$2d$hero$2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('user_profiles').upsert({
                    id: data.user.id,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a47dc45c._.js.map