...
class QuizService {
    ...
    static async getQuizQuestion(phase, stage) {
        try {
            ...
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$work$2f$health$2d$hero$2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('quizzes').select('*').eq('qnum', qnum).single();
            if (error) {
    ...
    static async getPhaseQuestions(phase) {
        try {
            ...
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$work$2f$health$2d$hero$2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('quizzes').select('*').gte('qnum', startQnum).lte('qnum', endQnum).order('qnum', {
                ascending: true
            });
            if (error) {
    ...
    static async getAllQuestions() {
        try {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$work$2f$health$2d$hero$2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('quizzes').select('*').order('qnum', {
                ascending: true
            });
            if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0680c739._.js.map