...
**현재 단계**: Phase 4 완료 + 나가기 확정 모달 시스템 + 성능 최적화 완료
...
- `src/components/GameHeader.tsx`: 게임 헤더 컴포넌트 (하트 시스템, 나가기 모달 포함)
- `src/components/SettingsDropdown.tsx`: 설정 드롭다운 메뉴 컴포넌트 (나가기 모달 연동)
