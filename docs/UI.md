...
- **하트 시스템**:
  ...
  - 차감 조건:
    - 스테이지 진입 시: -1
    - 문제 오답 시: -1
  - 하트 부족 시: 하트 부족 모달창 표시 (Section 7.11 참조) ✅
  - 광고 충전: 광고 시청을 통해 하트 충전 가능 (AdMob 자동 처리) ✅
...
**Status**: 기획 완료 ✅ (페이즈 선택 페이지, 스테이지 선택 페이지, 퀴즈 풀이 페이지, 문제 결과 페이지, 스테이지 결과 페이지, 설정 메뉴, 아이템 설명 모달창, 나가기 모달창, 하트 부족 모달창, 아이템 사용 모달창, 힌트 모달창)  
**Next Steps**:

1. Phase 1 구현 시작 (상단 Header UI, 중앙 맵 레이아웃, 페이즈 카드)
2. 스테이지 선택 페이지 기본 UI 구조 구현
3. 퀴즈 풀이 페이지 UI 구현
4. 문제 결과 페이지 UI 구현
5. 스테이지 결과 페이지 UI 구현
6. 설정 메뉴 UI 구현
